...
class WeightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create weight" do
    assert_difference('Weight.count') do
      post weights_url, params: { weight: { patient_id: @weight.patient_id, weigh_month: @weight.weigh_month, weight: @weight.weight } }
    end
  ...
  test "should update weight" do
    patch weight_url(@weight), params: { weight: { patient_id: @weight.patient_id, weigh_month: @weight.weigh_month, weight: @weight.weight } }
